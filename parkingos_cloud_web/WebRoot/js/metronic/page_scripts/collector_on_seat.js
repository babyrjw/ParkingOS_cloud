var TableDatatablesCollector = function () {
        ...
        var oTable = table.dataTable({
            ...
            "columns":[ 
                ...
                { 
                	...
                	"render": function ( data, type, full, meta ){
                		if(data == 0){
                			return '<span class="label label-sm label-danger"> 不在位 </span>';  
                		}else if(data == 1){
                			return '<span class="label label-sm label-success"> 在位 </span>';  
                		}
                    }
                }
            ],
...
//        	    alert("rowCallback");
            ...
            "serverSide": true,
            "ajax":{
            	"url": "cityindex.do?action=collector", // ajax URL
